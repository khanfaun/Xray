...
import { saveProject, getDistinctFolders } from '../db';
import { 
...
export default function AfterImageModal({
  ...
  // Process a batch of AFTER files with non-blocking UI chunks
  ...
  const handleBatchCreateProjects = async () => {
    ...
    try {
      ...
      setBatchNotice(`Đã lưu thành công ${matchedItems.length} dự án vào thư mục "${targetFolder}"!`);
